  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap font-medium ring-offset-background transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        hero: "hero-gradient text-white font-semibold shadow-coral hover:shadow-lg hover:scale-105 transform transition-all duration-200 rounded-xl",
        waitlist: "bg-accent-teal text-white font-semibold shadow-teal hover:bg-accent-teal-dark hover:shadow-lg hover:scale-105 transform transition-all duration-200 rounded-xl",
        app: "bg-foreground text-background font-semibold hover:bg-foreground/90 hover:shadow-lg hover:scale-105 transform transition-all duration-200 rounded-xl",
        outlined: "border-2 border-primary text-primary bg-background hover:bg-primary hover:text-primary-foreground font-semibold transition-all duration-200 rounded-xl",
      },
      size: {
